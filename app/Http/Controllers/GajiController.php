...
class GajiController extends Controller
{
    ...
    public function getpegawai($id_pegawai)
    {
        ...
        $jabatan = \App\Jabatan::all();
            ...
            $hadir = 20-$sumsakit-$sumizin-$sumtp;
            ...
            echo ' <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama" id="nama" readonly="" value="'.$pegawai->nama.'">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="sakit" disabled="" value="'.$sumsakit.'">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputIzin">Izin</label>
                  <input type="text" class="form-control" id="izin" disabled="" value="'.$sumizin.'">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputIzin">Alfa</label>
                  <input type="text" class="form-control" id="alfa" disabled="" value="'.$sumtp.'">
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="hari_kerja" disabled="" value="'.$hadir.'">
                </div>
                <div class="form-group col-md-4">
