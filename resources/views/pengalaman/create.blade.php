 ...
 <section role="main" class="content-body">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mt-3">
        ...
        <li class="breadcrumb-item"><a href="{{ route('pegawai.detail',$pegawai->id_pegawai) }}">Pengalaman</a></li>
    ...
    <section class="card mt-3">
        ...
        <div class="card-body" style="margin-left:200px;">
            <div class="col-md-24">
                <form action="{{ route('pengalaman.store',$pegawai->id_pegawai) }}" enctype="multipart/form-data" method="POST">
                    @csrf 
                    <div class="col-md-12"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                              <div class="input-group">
                                <input type="text" class="form-control mr-2" name="lama" required="">
