 ...
 <section role="main" class="content-body">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mt-3">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Akun Manajer</li>
      </ol>
    </nav>
    ...
    <section class="card mt-3">
        ...
        <div class="card-body">
            <div class="col-md-12">
                <form action="{{ route('akunmanajer.store') }}" method="POST">
                    @csrf 
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="status" value="Manajer" readonly="">
                            </div>
